...
final class MessageViewController: MessagesViewController {
    ...
    private func listernForNewChats() {
        ...
        presenter?.listenForNewChats(documentId: currentUID, collectionId: chatId, lastMessageDate: lastMessage)
    }
    ...
    private func attachButton() -> InputBarButtonItem {
        ...
        attachButton.image = UIImage(systemName: "paperclip")?.withConfiguration(UIImage.SymbolConfiguration(pointSize: 20)).withTintColor(.gray, renderingMode: .alwaysOriginal)
